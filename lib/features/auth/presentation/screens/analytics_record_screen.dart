...
//               Expanded(
//                 child: _buildAnnualBarChart(response.monthlyData, formatter), // 🆕 formatter ထည့်ပို့ပါ
//               ),
//             ],
//           ],
//         ),
...
//         Expanded(
//           child: Padding(
//             // 🆕 amount label တွေ bar အပေါ်ကို ပေါ်စေဖို့ top padding ထပ်ချဲ့ပါ
//             padding: const EdgeInsets.only(top: 18.0, bottom: 2.0, left: 8.0, right: 8.0),
//             child: BarChart(
//               BarChartData(
//                 alignment: BarChartAlignment.spaceAround,
//                 // 🆕 label အတွက် နေရာချန်ဖို့ maxY ကို ပိုမြင့်ပေးပါ
//                 maxY: maxAmount * 1.35,
//                 barTouchData: BarTouchData(
//                   enabled: true,
//                   // 🆕 tap မလုပ်ရင်လည်း label ကို အမြဲပြထားရန်
//                   touchTooltipData: BarTouchTooltipData(
//                     tooltipBgColor: Colors.transparent, // Fix: Use tooltipBgColor for transparent background
...
//                     x: index,
//                     // 🆕 index 0 (rod ID 0) ရဲ့ tooltip ကို အမြဲ show လုပ်ခိုင်းသည်
...
class AnalyticalRecordPageState extends State<AnalyticalRecordPage> {
  ...
  void _loadAnalyticsData() {
    // ဒေတာအသစ်ကို ဆွဲယူတော့မည်ဖြစ်၍ dirty flag ကို ရှင်းလိုက်သည်
  ...
  // 🆕 [FIX] tab ကို ပြန်ဝင်တိုင်း data ကို အတင်း reload မလုပ်တော့ဘဲ,
  // transaction ပြောင်းလဲမှုကြောင့် dirty ဖြစ်နေမှသာ fetch အသစ်လုပ်သည်.
  // ဒါဆိုရင် analytics tab ကို ထပ်ခါထပ်ခါ ပြန်ဝင်တာက ချက်ချင်း
  // ဒေတာအဟောင်းကို ချက်ချင်းပြပေးနိုင်ပြီး app ကွန်ရက်ခေါ်ဆိုမှု လျော့ကျပါမည်.
  void refreshCurrentSelection() {
