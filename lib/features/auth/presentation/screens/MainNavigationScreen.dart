...
//   // MainNavigationScreenState ထဲတွင် ထည့်ပါ
// void onTabTapped(int index) {
//   setState(() {
//     _currentTabIndex = index;
//     // Category သို့မဟုတ် Record History သို့သွားလျှင် State ပြန်ချိန်ပါ
//     if (index == 2 || index == 3) {
...
//   // 🆕 [FIX] Analytics page ရဲ့ state ကို ကိုယ်တိုင် ခေါ်ဖို့ GlobalKey
...
//     _pages = [
//       const HomeScreen(),
//       AnalyticalRecordPage(key: _analyticsKey), // 🆕 key ထည့်
//       CategoryScreen(
...
//                       // 🆕 [FIX] Hardcoded FetchAnalyticsEvent(expense/week/this) ကို ဖယ်ပြီး
//                       // page ကိုယ်တိုင် မှတ်ထားတဲ့ selection အတိုင်း refresh ခိုင်းပါ
//                       if (index == 1) {
//                         _analyticsKey.currentState?.refreshCurrentSelection();
//                       }
                ...
                return SizedBox(
                  ...
                  child: GestureDetector(
                    ...
                    onTap: () {
                      ...
                      // Tab ပြောင်းတိုင်း LoadTransactions() ကို ဒီနေရာမှာ ထပ်မခေါ်တော့ပါ --
                      // RecordHistoryScreen ကို IndexedStack ထဲမှာ state မပျက်စေဘဲ
                      // ဆက်ထားထားပြီးသားဖြစ်လို့ (initState တစ်ခါပဲ run မယ်) ၊ transaction
                      // အသစ်တွေက TransactionBloc ကတစ်ဆင့် ရှိပြီးသား listener က
                      // အလိုအလျောက် update ဖြစ်သွားမှာမို့ပါ။
                    },
                    child: Center(
                      child: isSelected
                          ? const SizedBox.shrink()
