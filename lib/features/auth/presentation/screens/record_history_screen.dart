...
//                       children: [
//                         _buildDialogTabButton(
//                           "Select by Date", 
//                           isSelectByDate, 
//                           () => setDialogState(() => tempFilterType = 'date')
//                         ),
//                         _buildDialogTabButton(
//                           "Select by Period", 
//                           !isSelectByDate, 
//                           () => setDialogState(() => tempFilterType = 'period')
//                         ),
//                       ],
//                     ),
...
//                                   child: Text("${2020 + index}", style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w500)),
//                                 )),
//                               ),
//                             ),
//                             Expanded(
...
//                       // 🎯 Last Month, Last 3 Month, Last 1 Year ခလုတ်တွေကို တစ်တန်းတည်း ဖြစ်သွားအောင် လုပ်ထားပါတယ်
//                       SingleChildScrollView(
//                         scrollDirection: Axis.horizontal,
//                         physics: const BouncingScrollPhysics(),
//                         child: Row(
//                           children: [
//                             _buildQuickPeriodButton(
//                               "Last Month", 
...
//                               tempStart != null ? DateFormat('dd/MM/yyyy').format(tempStart!) : "Start Time", 
//                               () async {
...
//                             child: Text("to", style: TextStyle(fontWeight: FontWeight.w500, color: Colors.black54)),
//                           ),
//                           Expanded(
//                             child: _buildTimePickerBox(
//                               tempEnd != null ? DateFormat('dd/MM/yyyy').format(tempEnd!) : "End Time", 
//                               () async {
//                                 final picked = await showDatePicker(
//                                   context: context,
...
//                       // 🎯 ပုံထဲကလို ထပ်နေတဲ့ CupertinoPicker ရက်စွဲပြသမှုအပိုင်းကို လုံးဝ ဖြုတ်ပစ်လိုက်ပါပြီ။
//                     ],
...
//               color: isActive ? primaryPurple : Colors.black87
//             ),
//           ),
...
//       child: Container(
//         // 🎯 စာလုံးတွေ တစ်ကြောင်းတည်း လှလှပပဆံ့သွားအောင် Card Padding ကို ညှိပေးထားပါတယ်
//         padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 12),
//         decoration: BoxDecoration(
//           color: isActive ? primaryPurple : lightPurpleBg,
//           borderRadius: BorderRadius.circular(12),
//         ),
//         child: Text(
//           label, 
...
//       borderRadius: BorderRadius.circular(12),
//       child: Container(
//         // 🎯 ရက်စွဲစာလုံးတွေ အောက်မဆင်းသွားအောင် Box Padding ကို ချဲ့ပေးထားပါတယ်
//         padding: const EdgeInsets.symmetric(vertical: 14, horizontal: 10),
//         alignment: Alignment.center,
//         decoration: BoxDecoration(
//           color: lightPurpleBg,
//           borderRadius: BorderRadius.circular(12),
//           border: text.contains('/') ? Border.all(color: primaryPurple, width: 1) : null,
//         ),
//         child: Text(
//           text, 
//           style: TextStyle(
//             color: text.contains('/') ? primaryPurple : Colors.grey, 
//             fontSize: 13, 
...
//                           child: Text("No categories available for this type", style: TextStyle(color: Colors.grey)),
//                         )
//                       : StatefulBuilder(
...
//                                       alignment: Alignment.center, 
//                                       decoration: BoxDecoration(
//                                         color: isSelected ? primaryPurple : lightPurpleBg,
//                                         borderRadius: BorderRadius.circular(8),
//                                       ),
//                                       child: Text(
//                                         category.name,
...
//             padding: const EdgeInsets.all(10),
//             decoration: BoxDecoration(
//               color: _selectedFilterCategories.isNotEmpty ? primaryPurple : Colors.white, 
//               borderRadius: BorderRadius.circular(12),
//             ),
//             child: Icon(
//               Icons.filter_alt_outlined, 
//               color: _selectedFilterCategories.isNotEmpty ? Colors.white : Colors.black54, 
//               size: 20,
//             ),
//           ),
//         ),
...
//             padding: const EdgeInsets.all(10),
//             decoration: BoxDecoration(
//               color: _calendarFilterType != 'none' ? primaryPurple : Colors.white, 
//               borderRadius: BorderRadius.circular(12)
//             ),
//             child: Icon(
//               Icons.calendar_month_outlined, 
//               color: _calendarFilterType != 'none' ? Colors.white : Colors.black54, 
//               size: 20
//             ),
//           ),
//         ),
...
//           list = list.where((tx) {
//             return tx.createdAt.year == _selectedYear && tx.createdAt.month == _selectedMonth;
//           }).toList();
//         } else if (_calendarFilterType == 'period' && _startDate != null && _endDate != null) {
//           final startCondition = DateTime(_startDate!.year, _startDate!.month, _startDate!.day);
//           final endCondition = DateTime(_endDate!.year, _endDate!.month, _endDate!.day, 23, 59, 59);
//           list = list.where((tx) {
//             return tx.createdAt.isAfter(startCondition) && tx.createdAt.isBefore(endCondition);
//           }).toList();
//         }
...
//                 crossAxisAlignment: CrossAxisAlignment.start,
//                 children: [
//                   const Text("Start Date", style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: Colors.black)),
//                   const SizedBox(height: 2),
//                   Text(DateFormat('dd/MM/yyyy').format(_startDate!), style: const TextStyle(color: Colors.grey, fontSize: 13)),
//                 ],
//               ),
//               Column(
//                 crossAxisAlignment: CrossAxisAlignment.end,
//                 children: [
//                   const Text("End Date", style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: Colors.black)),
//                   const SizedBox(height: 2),
//                   Text(DateFormat('dd/MM/yyyy').format(_endDate!), style: const TextStyle(color: Colors.grey, fontSize: 13)),
//                 ],
//               ),
//             ],
//           );
//         } else {
//           String currentMonthYear = DateFormat('MMMM - yyyy').format(DateTime(_selectedYear, _selectedMonth));
//           headerTitleWidget = Row(
//             mainAxisAlignment: MainAxisAlignment.spaceBetween,
//             children: [
...
//                     _activePeriodShortcut = 'none';
//                     _selectedYear = DateTime.now().year;
//                     _selectedMonth = DateTime.now().month;
//                     _startDate = null;
//                     _endDate = null;
//                   }),
//                   child: Text("Clear Filter", style: TextStyle(color: primaryPurple, fontSize: 13, fontWeight: FontWeight.w600)),
//                 ),
//             ],
//           );
//         }
...
class _RecordHistoryScreenState extends State<RecordHistoryScreen> {
  ...
  void initState() {
    super.initState();
    // 🚀 ဒေတာအားလုံးကို တစ်ခါတည်း ကြိုတင်ဆွဲထုတ်ထားပါမယ် (UI ကနေ စိတ်ကြိုက် group ခွဲထုတ်ဖို့အတွက်)
    BlocProvider.of<TransactionBloc>(context).add(LoadTransactions());
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color(0xFFEDE7F6), 
      body: SafeArea(
        child: BlocBuilder<TransactionBloc, TransactionStateBase>(
          builder: (context, state) {
            if (state is TransactionLoading) {
              return Center(child: CircularProgressIndicator(color: primaryPurple));
            }
            ...
            if (_selectedFilterCategories.isNotEmpty) {
              ...
              if (categoryState is CategoryLoaded) {
                rawList = rawList.where((tx) {
                  final cat = categoryState.categories.firstWhere((c) => c.id == tx.categoryId, orElse: () => CategoryItem(id: '', name: '', icon: Icons.help, color: Colors.black, type: ''));
            ...
            if (_calendarFilterType == 'date') {
              ...
              // Start Date ရဲ့ အစ (00:00:00) ကနေ End Date ရဲ့ အဆုံး (23:59:59) အထိ စစ်ထုတ်ပေးခြင်း
            ...
            // 🎯 [အသက်သွေးကြောအပိုင်း] ဒေတာများကို လအလိုက် (Year-Month) ပုံစံဖြင့် Group ဖွဲ့ခွဲထုတ်ခြင်း
                    ...
                    groupedTransactions.isEmpty 
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, groupIndex) {
                            ...
                            // တစ်လချင်းစီအလိုက် Income / Expense တွက်ချက်ခြင်း
  ...
  // 🎯 လအလိုက် ကတ်ပြားသီးသန့် ထုတ်ပေးမည့် Custom Card Widget
  ...
  //               behavior: HitTestBehavior.opaque,
  //               onTap: () {
  //                 Navigator.push(context, MaterialPageRoute(builder: (context) => TransactionDetailScreen(transaction: tx, categoryName: finalCategoryName, categoryIcon: finalIcon, categoryColor: finalColor)));
  //               },
  //               child: Row(
  //                 children: [
  //                   CircleAvatar(radius: 24, backgroundColor: finalColor.withOpacity(0.15), child: Icon(finalIcon, color: finalColor, size: 22)),
  //                   const SizedBox(width: 12),
  //                   Expanded(
  //                     child: Column(
  //                       crossAxisAlignment: CrossAxisAlignment.start,
  ...
  //                         child: Text(tx.type, style: TextStyle(color: isExpense ? Colors.red : Colors.green, fontSize: 10, fontWeight: FontWeight.bold)),
  //                       ),
  //                     ],
  //                   ),
  //                 ],
          ...
          ListView.separated(
            ...
            itemBuilder: (context, idx) {
              ...
              return GestureDetector(
                ...
                child: Row(
                  children: [
                    // 🌟 [ပြင်ဆင်ချက် ၁] ဒုတိယပုံစံအတိုင်း နောက်ခံကို Solid Color အပြည့်သုံးပြီး Icon ကို အဖြူရောင် ပြောင်းလဲထားပါတယ်
                    CircleAvatar(
                      radius: 24, 
                      backgroundColor: finalColor, 
                      child: Icon(finalIcon, color: Colors.white, size: 22)
                    ...
                    Column(
                      ...
                      children: [
                        Text(isExpense ? "-${formatter.format(tx.amount)}" : "+${formatter.format(tx.amount)}", style: TextStyle(color: isExpense ? Colors.red : Colors.green, fontWeight: FontWeight.bold, fontSize: 16)),
                        const SizedBox(height: 4),
                        // 🌟 [ပြင်ဆင်ချက် ၂] တောင်းဆိုထားတဲ့ up arrow / down arrow လေးတွေ badge ထဲ ပြန်ထည့်ထားပါတယ်
                        Container(
                          padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 3),
                          decoration: BoxDecoration(color: isExpense ? const Color(0xFFFFE4E6) : const Color(0xFFDCFCE7), borderRadius: BorderRadius.circular(12)),
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(
                                tx.type, 
                                style: TextStyle(color: isExpense ? Colors.red : Colors.green, fontSize: 10, fontWeight: FontWeight.bold),
                              ),
                            ],
                          ),
                        ),
  ...
  //     mainAxisAlignment: MainAxisAlignment.spaceBetween,
  //     children: [
  //       GestureDetector(onTap: () { if (widget.onTabChanged != null) widget.onTabChanged!(0); }, child: Container(padding: const EdgeInsets.all(10), decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(12)), child: const Icon(Icons.arrow_back_ios_new, size: 16, color: Colors.black))),
  //       const Text("Transaction History", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.black)),
  //       GestureDetector(onTap: () { if (widget.onTabChanged != null) widget.onTabChanged!(0); }, child: Container(padding: const EdgeInsets.all(10), decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(12)), child: const Icon(Icons.close, size: 16, color: Colors.black))),
  //     ],
  //   );
  // }
  Widget _buildTopHeader() {
    return Row(
      ...
      children: [
        ...
        const Text("Transaction History", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.black)),
        // 🌟 [ပြင်ဆင်ချက် ၃] Cross (X) Box လေးကို ဖယ်ထုတ်ပြီး နေရာလွတ်ညှိပေးထားပါတယ်
