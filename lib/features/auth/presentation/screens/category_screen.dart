  ...
  void _showActionBottomSheet(CategoryItem item) {
    showModalBottomSheet(
      ...
      builder: (context) => Container(
        ...
        decoration: const BoxDecoration(color: Color(0xFFF7F5FC), borderRadius: BorderRadius.only(topLeft: Radius.circular(24), topRight: Radius.circular(24))),
        child: SafeArea(
          child: Column(
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: TabBar(
                                ...
                                indicator: BoxDecoration(borderRadius: BorderRadius.circular(12), color: const Color(0xFF7F3DFF)),
                                tabs: const [
