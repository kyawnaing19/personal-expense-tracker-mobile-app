                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      child: const Row(
                        ...
                        children: [Icon(Icons.add, color: Colors.white), SizedBox(width: 6), Text('ADD', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 16))],
                      ),
                    ),
                  ),
                  const SizedBox(height: 16),
  ...
  Widget _buildTopHeader() {
    return Row(
      ...
      children: [
        ...
        const Text('Recurring Transactions', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.black)),
            ...
            child: Column(
              ...
              children: [
                ...
                Row(children: [
                  ...
                  Text(item.frequencyLabel, style: const TextStyle(color: Colors.grey, fontSize: 12)),
                ]),
                const SizedBox(height: 2),
                Text('Next: ${DateFormat('MMM d, yyyy').format(_nextDisplayDate(item))}', style: const TextStyle(color: Colors.grey, fontSize: 11)),
              ],
            ),
          ),
          Column(
            ...
            children: [
              Text(formatter.format(item.amount), style: const TextStyle(color: Colors.red, fontWeight: FontWeight.bold, fontSize: 15)),
