...
//   final Color color;
//   final String type;
//   AddCategoryRequested({required this.name, required this.icon, required this.color, required this.type});
// }
...
//   final Color color;
//   final String type;
//   UpdateCategoryRequested({required this.id, required this.name, required this.icon, required this.color, required this.type});
// }
